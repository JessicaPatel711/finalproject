...
public class TileBoard {
    ...
    private void addAllTiles() {
        int pos = 1; // update the position of each tile
        ...
        public Tile(int position, int row, int col) {
            ...
            tilePane.setOnMouseClicked(event -> {
                ...
                if (thisPlayer.myTurn ) {
                    ...
                    if (thisPlayer.markedSpaces[position - 1] == null) {
                        thisPlayer.markedSpaces[position - 1] = thisPlayer.myMark;
                    }
                    ...
                    // send to the server
                    thisPlayer.sendMyMove(position, row, col);

                    // check for win or tie
                    thisPlayer.checkForWin();
                    thisPlayer.checkTie();
                }
